 ...
 * stereo.
 */
public class Labb5 extends GLJPanel implements GLEventListener, KeyListener{
    ...
    private void draw(GL2 gl2) {
        ...
        switch(objectNumber){    //choice of 3d object
            case 1: Corkscrew(8,gl2); break;
            case 2: Hexagon(8,gl2); break;
        }
    }
    ...
    private void Corkscrew(int n,GL2 gl2){
        ...
        gl2.glColor3f((float) 0, 0.5F, 0.5F);// dark cyan color
